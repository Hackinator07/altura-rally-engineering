...
void applyFont() {
    ...
    lv_obj_set_style_text_font(lblClock,    f12, 0);
}
...
void buildMainUI() {
    ...
    lv_obj_set_pos(lblGpsStatic, 6, 8);
    ...
    lv_label_set_text(lblSatsStatic, "SATS:");
    lv_obj_set_pos(lblSatsStatic, 6, 26);
    ...
    // FRZ button: top-left, below signal label
    ...
    btnFrz = makeBtn(scr_main, 4, 46, 60, 28, freeze_cb, LV_EVENT_VALUE_CHANGED);
    ...
    lv_obj_set_size(lblClock, 160, 20);
    lv_obj_set_pos(lblClock, 80, 4);
    ...
    lv_obj_set_pos(speedCont, 60, 24);
