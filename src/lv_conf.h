 ...
 *
 * v1.0.24-NeoGPS: LV_USE_ARC enabled (1) — required by LV_USE_SPINNER.
 *   LV_USE_SPINNER enabled (1) — GPS and HDOP no-fix animated red arc indicators.
 *
 ...
 *====================*/
#define LV_USE_ARC        1   /* required by LV_USE_SPINNER (v1.0.24-NeoGPS) */
#define LV_USE_BAR        0
...
#define LV_USE_SPINNER    1   /* GPS/HDOP no-fix animated arc (v1.0.24-NeoGPS) */
